...
$docPath = Join-Path $base 'Kien_truc_he_thong_BaiTapSo2_Nhom1_Nhom1.docx'
$pdfPath = Join-Path $base 'Kien_truc_he_thong_BaiTapSo2_Nhom1_Nhom1.pdf'
...
$g.DrawString('(Theo style Task2 - Nhóm 1)', $fontSmall, $brushText, 735, 54)
...
Add-Line 'Thực hiện theo cấu trúc a-b-c-d-e và tham chiếu mẫu Task2 - Nhóm 1' 1 12 $false 14
...
$doc.SaveAs2($docPath, $wdFormatDocumentDefault)

...
$menu = Invoke-RestMethod -Method Get -Uri "$base/api/gateway/customer/menu" -WebSession $s | ConvertTo-Json -Depth 8
$menu | Select-String 'DEL_RT_' | ForEach-Object { $_.Line }
